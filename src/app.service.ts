...
export class AppService {
  ...
  getConfig(): AppConfig {
    // Only non-sensitive, non-secret configuration values are returned here.
    // Credentials (DB user/password, connection strings, API keys, etc.)
    ...
    return {
      ...
      dbSchema: this.configService.get<string>(
