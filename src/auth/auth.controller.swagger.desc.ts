...
export const SWAGGER_DESC_LOGIN_WITH_WEAK_KEY_JWT = `
...
export const SWAGGER_DESC_REQUEST_WITH_DOM_CSRF_TOKEN = `
    Authenticates user and returns DOM CSRF token.
`;

export const SWAGGER_DESC_REQUEST_WITH_SIMPLE_CSRF_TOKEN = `
    Returns Simple CSRF token.
`;

export const SWAGGER_DESC_VALIDATE_WITH_WEAK_KEY_JWT = `
...
export const SWAGGER_DESC_LOGIN_WITH_JKU_JWT = `
    Authenticates user and returns JWT token with HCA256. The key is configurable on server via the JWT_SECRET_KEY env variable.
`;

export const SWAGGER_DESC_VALIDATE_WITH_JKU_JWT = `
...
export const SWAGGER_DESC_LOGIN_WITH_JWK_JWT = `
    Authenticates user and returns JWT token with HCA256. The key is configurable on server via JWT_SECRET_KEY env variable.
`;

export const SWAGGER_DESC_VALIDATE_WITH_JWK_JWT = `
    Vulrenability case: JWK field JSON in Header has empty values and our private key to sign the JWT
`;

export const SWAGGER_DESC_LOGIN_WITH_X5C_JWT = `
    Authenticates user and returns JWT token with HCA256. The key is configurable on server via the JWT_SECRET_KEY env variable.
`;

export const SWAGGER_DESC_VALIDATE_WITH_X5C_JWT = `
...
export const SWAGGER_DESC_LOGIN_WITH_X5U_JWT = `
    Authenticates user and returns JWT token with HCA256. The key is configurable on server via the JWT_SECRET_KEY env variable.
`;

export const SWAGGER_DESC_VALIDATE_WITH_X5U_JWT = `
    Vulnerability case: Uses the uploaded certificate to sign the JWT and sets the X5U Header in JWT to point to the uploaded certificate.
`;
