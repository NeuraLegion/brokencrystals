...
- JWT returned in Authorization header: {{ auth_object.stages.login.response.headers.Authorization | match: /(?:Bearer\s+)?([^\s,;]+)/ }}
...
function nexTemplateHeaderReference(headerName: string): string {
  return headerName;
}
