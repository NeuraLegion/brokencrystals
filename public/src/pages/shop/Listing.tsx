          ...
          <div className="ps-product__column">
            <div className="ps-shoe mb-30">
              <div className="ps-shoe__thumbnail">
                ...
                <div className="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a className="ps-shoe__favorite" href="#"><i className="ps-icon-heart"/></a><img src="assets/img/crystals/amethyst.jpg" alt=""/><a className="ps-shoe__overlay" href="product-detail.html"/>
              </div>
              <div className="ps-shoe__content">
                <div className="ps-shoe__variants">
                  <div className="ps-shoe__variant normal"><img src="assets/img/crystals/amethyst.jpg" alt=""/><img src="assets/img/crystals/amethyst.jpg" alt=""/></div>
                ...
                <div className="ps-shoe__detail"><a className="ps-shoe__name" href="#">Amethyst</a>
                  <p className="ps-shoe__categories"><a href="#">Healing</a></p><span className="ps-shoe__price">
