              ...
              <div className="ps-cart"><a className="ps-cart__toggle" href="#"><span><i>20</i></span><i
                ...
                <div className="ps-cart__listing">
                  <div className="ps-cart__content">
                    ...
                    <div className="ps-cart-item"><a className="ps-cart-item__close" href="#"/>
                      <div className="ps-cart-item__thumbnail"><a href="product-detail.html"/><img
      ...
      <main className="ps-main">
        <div className="ps-content pt-80 pb-80">
          <div className="ps-container">
            <div className="ps-cart-listing ps-table--whishlist">
              <table className="table ps-cart__table">
                ...
                <tr>
                  ...
                  <td>$150</td>
                  <td><a className="ps-product-link" href="product-detail.html">View Product</a></td>
                  <td>
