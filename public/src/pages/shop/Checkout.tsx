                    ...
                    <footer>
                      ...
                      <div className="form-group paypal">
                        ...
                        <ul className="ps-payment-method">
                          <li><a href="#"><img src="shop/images/payment/1.png" alt=""/></a></li>
                          <li><a href="#"><img src="shop/images/payment/2.png" alt=""/></a></li>
                          <li><a href="#"><img src="shop/images/payment/3.png" alt=""/></a></li>
                        </ul>
                        <button className="ps-btn ps-btn--fullwidth">Place Order<i className="ps-icon-next"/>
                        </button>
                      </div>
                    </footer>
                  </div>
