  ...
  return (
    <>
            ...
            <div className="row">
              ...
              <div className="col-lg-6 col-md-4 col-sm-6 col-xs-12 ">
                <div className="header__actions"><a href="#">Login & Regiser</a>
                  <div className="btn-group ps-dropdown"><a className="dropdown-toggle" href="#" data-toggle="dropdown"
                                                            aria-haspopup="true" aria-expanded="false">USD<i
                    className="fa fa-angle-down"/></a>
                    <ul className="dropdown-menu">
                      <li><a href="#"><img src="shop/images/flag/usa.svg" alt=""/> USD</a></li>
                      <li><a href="#"><img src="shop/images/flag/singapore.svg" alt=""/> SGD</a></li>
                      <li><a href="#"><img src="shop/images/flag/japan.svg" alt=""/> JPN</a></li>
                    </ul>
                  </div>
                  <div className="btn-group ps-dropdown"><a className="dropdown-toggle" href="#" data-toggle="dropdown"
        ...
        <nav className="navigation">
          <div className="container-fluid">
            <div className="navigation__column left">
              <div className="header__logo"><a className="ps-logo" href="index.html"><img src="shop/images/logo.png" alt=""/></a>
              </div>
            </div>
            ...
            <div className="navigation__column right">
              ...
              <div className="ps-cart"><a className="ps-cart__toggle" href="#"><span><i>20</i></span><i
                className="ps-icon-shopping-cart"/></a>
                <div className="ps-cart__listing">
                  <div className="ps-cart__content">
                    <div className="ps-cart-item"><a className="ps-cart-item__close" href="#"></a>
                      <div className="ps-cart-item__thumbnail"><a href="product-detail.html"></a><img
                        src="shop/images/cart-preview/1.jpg" alt=""/></div>
                      <div className="ps-cart-item__content"><a className="ps-cart-item__title"
                    ...
                    <div className="ps-cart-item"><a className="ps-cart-item__close" href="#"></a>
                      <div className="ps-cart-item__thumbnail"><a href="product-detail.html"></a><img
                        src="shop/images/cart-preview/2.jpg" alt=""/></div>
                      <div className="ps-cart-item__content"><a className="ps-cart-item__title"
                    ...
                    <div className="ps-cart-item"><a className="ps-cart-item__close" href="#"></a>
                      <div className="ps-cart-item__thumbnail"><a href="product-detail.html"></a><img
                        src="shop/images/cart-preview/3.jpg" alt=""/></div>
                      <div className="ps-cart-item__content"><a className="ps-cart-item__title"
                  ...
                  <div className="ps-cart__footer"><a className="ps-btn" href="cart.html">Check out<i
                    className="ps-icon-arrow-left"/></a></div>
                </div>
              </div>
      ...
      <div className="header-services">
        <div className="ps-services owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="7000"
             data-owl-gap="0" data-owl-nav="true" data-owl-dots="false" data-owl-item="1" data-owl-item-xs="1"
             data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000"
             data-owl-mousedrag="on">
          <p className="ps-service"><i className="ps-icon-delivery"/><strong>Free delivery</strong>: Get free
      ...
      <main className="ps-main">
          ...
          <div className="ps-container">
            <div className="ps-cart-listing">
              <table className="table ps-cart__table">
                ...
                <tbody>
                <tr>
                  <td><a className="ps-product__preview" href="product-detail.html"><img className="mr-15"
                                                                                         src="shop/images/product/cart-preview/1.jpg"
                                                                                         alt=""/> air jordan One mid</a>
                  </td>
                  <td>$150</td>
                  <td>
              ...
              <div className="ps-cart__actions">
                ...
                <div className="ps-cart__total">
                  <h3>Total Price: <span> 2599.00 $</span></h3><a className="ps-btn" href="checkout.html">Process to
                  checkout<i className="ps-icon-next"/></a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="ps-footer bg--cover" data-background="shop/images/background/parallax.jpg">
          <div className="ps-footer__content">
            <div className="ps-container">
              <div className="row">
                <div className="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                  <aside className="ps-widget--footer ps-widget--info">
                    <header><a className="ps-logo" href="index.html"><img src="shop/images/logo-white.png" alt=""/></a>
