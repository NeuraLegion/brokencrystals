...
Reasoning effort is applied only to non-tool chat/schema calls. Function-tool calls skip
it because some chat-completions providers reject `tools` together with
`reasoning_effort`.
