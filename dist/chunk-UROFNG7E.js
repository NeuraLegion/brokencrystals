...
var S = class {
  ...
  push(e2) {
    const t2 = this._back;
    let r2 = t2;
    (16383 === t2._elements.length && (r2 = { _elements: [], _next: void 0 }),
  ...
  forEach(e2) {
    ...
    for (
      ;
      !(
        (t2 === o2.length && void 0 === r2._next) ||
        (t2 === o2.length &&
          ((r2 = r2._next), (o2 = r2._elements), (t2 = 0), 0 === o2.length))
      );
    )
      (e2(o2[t2]), ++t2);
  }
...
function W(e2) {
  ...
  ("readable" === t2._state
    ...
    t2._readableStreamController[C](),
    (t2._reader = void 0),
    (e2._ownerReadableStream = void 0));
}
function k(e2) {
...
function A(e2, t2) {
  void 0 !== e2._closedPromise_reject &&
    (m(e2._closedPromise),
    e2._closedPromise_reject(t2),
    (e2._closedPromise_resolve = void 0),
    (e2._closedPromise_reject = void 0));
}
function j(e2) {
  void 0 !== e2._closedPromise_resolve &&
    (e2._closedPromise_resolve(void 0),
    (e2._closedPromise_resolve = void 0),
    (e2._closedPromise_reject = void 0));
}
  ...
  if (
    !(
      /* @__PURE__ */ (function (e3) {
        return (
          ("object" == typeof e3 && null !== e3) || "function" == typeof e3
        );
      })(e2)
    )
  )
...
function N(e2, t2) {
  ...
  if (
    ...
    throw new TypeError(
      `${t2} is outside the accepted range of 0 to ${r2}, inclusive`,
    );
      ...
      (function (e3, t3) {
        ...
        ((r3._disturbed = true),
          "closed" === r3._state
            ? t3._closeSteps()
            : "errored" === r3._state
              ? t3._errorSteps(r3._storedError)
              : r3._readableStreamController[q](t3));
      })(this, {
        _chunkSteps: (t3) => e2({ value: t3, done: false }),
        _closeSteps: () => e2({ value: void 0, done: true }),
      ...
      : f(
          ...
          (e3) => {
            ...
            throw (
              (this._ongoingPromise = void 0),
              (this._isFinished = true),
              null === (t2 = this._reader) || void 0 === t2 || t2.releaseLock(),
              (this._reader = void 0),
              e3
            );
          },
...
(Object.defineProperties(ReadableStreamBYOBRequest.prototype, {
  ...
  "symbol" == typeof e.toStringTag &&
    Object.defineProperty(ReadableStreamBYOBRequest.prototype, e.toStringTag, {
...
function be(e2) {
  ...
  b(
    ...
    () => (
      (e2._pulling = false),
      e2._pullAgain && ((e2._pullAgain = false), be(e2)),
      null
    ),
    (t3) => (Pe(e2, t3), null),
  );
...
function pe(e2) {
  const t2 = e2.bytesFilled,
    r2 = e2.elementSize;
  return new e2.viewConstructor(e2.buffer, e2.byteOffset, t2 / r2);
}
function me(e2, t2, r2, o2) {
  (e2._queue.push({ buffer: t2, byteOffset: r2, byteLength: o2 }),
...
function ge(e2, t2) {
  (t2.bytesFilled > 0 && ye(e2, t2.buffer, t2.byteOffset, t2.bytesFilled),
    Ce(e2));
}
function we(e2, t2) {
  const r2 = t2.elementSize,
    o2 = t2.bytesFilled - (t2.bytesFilled % r2),
    n2 = Math.min(e2._queueTotalSize, t2.byteLength - t2.bytesFilled),
    a2 = t2.bytesFilled + n2,
    i2 = a2 - (a2 % r2);
  let l2 = n2,
    s2 = false;
  ...
  for (; l2 > 0; ) {
    const r3 = u2.peek(),
      o3 = Math.min(l2, r3.byteLength),
      n3 = t2.byteOffset + t2.bytesFilled;
    (ie(t2.buffer, n3, r3.buffer, r3.byteOffset, o3),
      r3.byteLength === o3
        ? u2.shift()
        : ((r3.byteOffset += o3), (r3.byteLength -= o3)),
...
function ve(e2) {
  0 === e2._queueTotalSize && e2._closeRequested
    ? (Ee(e2), Xt(e2._controlledReadableByteStream))
    : be(e2);
}
function Re(e2) {
  null !== e2._byobRequest &&
    ((e2._byobRequest._associatedReadableByteStreamController = void 0),
...
function qe(e2, t2) {
  ...
  Re(e2);
  ("closed" === e2._controlledReadableByteStream._state
    ? (function (e3, t3) {
    ...
    : (function (e3, t3, r3) {
        ...
        ((r3.bytesFilled -= o2),
          _e(e3._controlledReadableByteStream, r3),
          Te(e3));
      })(e2, t2, r2),
    be(e2));
}
...
function Oe(e2, t2, r2) {
  ...
  ((n2 = void 0 !== t2.start ? () => t2.start(o2) : () => {}),
    (a2 = void 0 !== t2.pull ? () => t2.pull(o2) : () => c(void 0)),
    (i2 = void 0 !== t2.cancel ? (e3) => t2.cancel(e3) : () => c(void 0)));
  const l2 = t2.autoAllocateChunkSize;
  if (0 === l2)
    throw new TypeError("autoAllocateChunkSize must be greater than 0");
  !(function (e3, t3, r3, o3, n3, a3, i3) {
    ((t3._controlledReadableByteStream = e3),
      (t3._pullAgain = false),
      (t3._pulling = false),
      (t3._byobRequest = null),
      (t3._queue = t3._queueTotalSize = void 0),
      ce(t3),
      (t3._closeRequested = false),
      (t3._started = false),
      (t3._strategyHWM = a3),
      (t3._pullAlgorithm = o3),
      (t3._cancelAlgorithm = n3),
      (t3._autoAllocateChunkSize = i3),
      (t3._pendingPullIntos = new S()),
      (e3._readableStreamController = t3),
      b(
        c(r3()),
        () => ((t3._started = true), be(t3), null),
        (e4) => (Pe(t3, e4), null),
      ));
...
var ReadableStreamBYOBReader = class {
  constructor(e2) {
    if (
      ($(e2, 1, "ReadableStreamBYOBReader"), V(e2, "First parameter"), Ut(e2))
    )
      throw new TypeError(
        "This stream has already been locked for exclusive reading by another reader",
      );
  ...
  read(e2) {
    ...
    return (
      (function (e3, t3, r3) {
        ...
        ((o3._disturbed = true),
          "errored" === o3._state
            ? r3._errorSteps(o3._storedError)
            : (function (e4, t4, r4) {
                const o4 = e4._controlledReadableByteStream;
                let n2 = 1;
                t4.constructor !== DataView &&
                  (n2 = t4.constructor.BYTES_PER_ELEMENT);
                const a2 = t4.constructor,
                  i2 = t4.buffer,
                  l2 = {
                    buffer: i2,
        ...
        _chunkSteps: (e3) => t2({ value: e3, done: false }),
        _closeSteps: (e3) => t2({ value: e3, done: true }),
...
(Object.defineProperties(ReadableStreamBYOBReader.prototype, {
  ...
  "symbol" == typeof e.toStringTag &&
    Object.defineProperty(ReadableStreamBYOBReader.prototype, e.toStringTag, {
...
var WritableStream = class {
  constructor(e2 = {}, t2 = {}) {
    ...
    const r2 = Ye(t2, "Second parameter"),
      o2 = (function (e3, t3) {
        F(e3, t3);
        const r3 = null == e3 ? void 0 : e3.abort,
          o3 = null == e3 ? void 0 : e3.close,
          n3 = null == e3 ? void 0 : e3.start,
          a3 = null == e3 ? void 0 : e3.type,
          i2 = null == e3 ? void 0 : e3.write;
        return {
          abort:
            void 0 === r3
              ? void 0
              : Ne(r3, e3, `${t3} has member 'abort' that`),
          close:
            void 0 === o3
              ? void 0
              : He(o3, e3, `${t3} has member 'close' that`),
          start:
            void 0 === n3
              ? void 0
              : xe(n3, e3, `${t3} has member 'start' that`),
          write:
            void 0 === i2
              ? void 0
              : Ve(i2, e3, `${t3} has member 'write' that`),
          type: a3,
        };
      })(e2, "First parameter");
    var n2;
    (((n2 = this)._state = "writable"),
      (n2._storedError = void 0),
      (n2._writer = void 0),
      (n2._writableStreamController = void 0),
      (n2._writeRequests = new S()),
      (n2._inFlightWriteRequest = void 0),
      (n2._closeRequest = void 0),
      (n2._inFlightCloseRequest = void 0),
      (n2._pendingAbortRequest = void 0),
      (n2._backpressure = false));
    ...
    !(function (e3, t3, r3, o3) {
      ...
      !(function (e4, t4, r4, o4, n4, a4, i3, l3) {
        ((t4._controlledWritableStream = e4),
          (e4._writableStreamController = t4),
          (t4._queue = void 0),
          (t4._queueTotalSize = void 0),
          ce(t4),
          (t4._abortReason = void 0),
          (t4._abortController = (function () {
            if (Ue) return new AbortController();
          })()),
          (t4._started = false),
          (t4._strategySizeAlgorithm = l3),
          (t4._strategyHWM = i3),
          (t4._writeAlgorithm = o4),
          (t4._closeAlgorithm = n4),
          (t4._abortAlgorithm = a4));
        const s3 = bt(t4);
        nt(e4, s3);
        const u2 = r4();
        b(
          c(u2),
          () => ((t4._started = true), dt(t4), null),
          (r5) => ((t4._started = true), Ze(e4, r5), null),
        );
...
function Je(e2, t2) {
  ...
  ((e2._writableStreamController._abortReason = t2),
    null === (r2 = e2._writableStreamController._abortController) ||
      void 0 === r2 ||
      r2.abort(t2));
  const o2 = e2._state;
...
function Ke(e2) {
  ...
  var n2;
  return (
    void 0 !== o2 && e2._backpressure && "writable" === t2 && Et(o2),
    ue((n2 = e2._writableStreamController), lt, 0),
    dt(n2),
    r2
  );
}
...
function et(e2, t2) {
  ...
  (void 0 !== o2 && it(o2, t2),
    !(function (e3) {
      if (
        void 0 === e3._inFlightWriteRequest &&
        void 0 === e3._inFlightCloseRequest
      )
        return false;
      return true;
    })(e2) &&
...
function tt(e2) {
  ...
  if (
    ...
    (e2._writeRequests = new S()),
    void 0 === e2._pendingAbortRequest)
  )
    return void ot(e2);
  ...
  b(
    e2._writableStreamController[v](r2._reason),
    () => (r2._resolve(), ot(e2), null),
    (t3) => (r2._reject(t3), ot(e2), null),
  );
}
function rt(e2) {
...
function ot(e2) {
  void 0 !== e2._closeRequest &&
    (e2._closeRequest._reject(e2._storedError), (e2._closeRequest = void 0));
  const t2 = e2._writer;
  ...
  releaseLock() {
    ...
    void 0 !== this._ownerWritableStream &&
      (function (e2) {
        ...
        (it(e2, r2),
          (function (e3, t3) {
            "pending" === e3._closedPromiseState
              ? St(e3, t3)
              : (function (e4, t4) {
                  wt(e4, t4);
                })(e3, t3);
          ...
          (t2._writer = void 0),
          (e2._ownerWritableStream = void 0));
      })(this);
  }
  write(e2) {
    return at(this)
      ? void 0 === this._ownerWritableStream
        ...
        : (function (e3, t2) {
            const r2 = e3._ownerWritableStream,
              o2 = r2._writableStreamController,
              n2 = (function (e4, t3) {
                try {
...
function ut(e2) {
  ((e2._writeAlgorithm = void 0),
    (e2._closeAlgorithm = void 0),
    (e2._abortAlgorithm = void 0),
    (e2._strategySizeAlgorithm = void 0));
}
function ct(e2) {
...
function dt(e2) {
  ...
  r2 === lt
    ? (function (e3) {
        ...
        (ut(e3),
          b(
            ...
            () => (
              (function (e4) {
                (e4._inFlightCloseRequest._resolve(void 0),
                  (e4._inFlightCloseRequest = void 0),
                  "erroring" === e4._state &&
                    ((e4._storedError = void 0),
                    void 0 !== e4._pendingAbortRequest &&
                      (e4._pendingAbortRequest._resolve(),
                      (e4._pendingAbortRequest = void 0))),
                  (e4._state = "closed"));
                const t4 = e4._writer;
                void 0 !== t4 && vt(t4);
              })(t3),
    ...
    : (function (e3, t3) {
        ...
        b(
          e3._writeAlgorithm(t3),
          () => {
            !(function (e4) {
              (e4._inFlightWriteRequest._resolve(void 0),
                (e4._inFlightWriteRequest = void 0));
            })(r3);
            const t4 = r3._state;
...
function Ct(e2, t2) {
  void 0 !== e2._readyPromise_reject &&
    (m(e2._readyPromise),
    e2._readyPromise_reject(t2),
    (e2._readyPromise_resolve = void 0),
    (e2._readyPromise_reject = void 0),
    (e2._readyPromiseState = "rejected"));
}
function Et(e2) {
  void 0 !== e2._readyPromise_resolve &&
    (e2._readyPromise_resolve(void 0),
    (e2._readyPromise_resolve = void 0),
    (e2._readyPromise_reject = void 0),
  ...
  return u((P2, W2) => {
                ...
                (function () {
                  ...
                  return f(l2.ready, () =>
                    f(
                      i2.read(),
                      (e5) =>
                        !!e5.done || ((E2 = l2.write(e5.value)), m(E2), false),
                    ),
                  );
                })(),
                r3,
    ...
    function B2() {
      return (
        ...
        r2
          ...
          : z2(
              () => (
                Ge(t2) && ((T2 = rt(t2)), (R2 = t2._state)),
                T2 || "closed" === R2
                  ? c(void 0)
                  : "erroring" === R2 || "errored" === R2
                    ? d(_2)
                    : ((T2 = true), l2.close())
              ),
              false,
    ...
    function A2(e3) {
      return (
        w2 ||
          ((v2 = "errored"),
          (s2 = e3),
          o2 ? L2(true, e3) : z2(() => l2.abort(e3), true, e3)),
        null
      );
    }
    function j2(e3) {
      ...
      (void 0 !== a2 &&
        ((k2 = () => {
          const e3 =
            ...
            t3 = [];
          (o2 || t3.push(() => ("writable" === R2 ? l2.abort(e3) : c(void 0))),
            n2 ||
              t3.push(() => ("readable" === v2 ? i2.cancel(e3) : c(void 0))),
            z2(() => Promise.all(t3.map((e4) => e4())), true, e3));
        }),
        a2.aborted ? k2() : a2.addEventListener("abort", k2)),
      Vt(e2) && ((v2 = e2._state), (s2 = e2._storedError)),
      Ge(t2) && ((R2 = t2._state), (_2 = t2._storedError), (T2 = rt(t2))),
      Vt(e2) && Ge(t2) && ((q2 = true), g2()),
      "errored" === v2)
    )
      A2(s2);
    ...
    function F2(e3, t3) {
      return (
        ...
        l2.releaseLock(),
        i2.releaseLock(),
        void 0 !== a2 && a2.removeEventListener("abort", k2),
        e3 ? W2(t3) : P2(void 0),
        null
      );
    }
    ...
    ? (function (e3) {
        ...
        function y2(e4) {
          _(
            ...
            (t4) => (
              e4 !== i2 ||
                (o2.error(t4), n2.error(t4), (h2 && p2) || a2(void 0)),
              null
            ),
          );
        }
        function g2() {
          (l2 &&
            (i2.releaseLock(), (i2 = e3.getReader()), y2(i2), (l2 = false)),
            b(
              i2.read(),
              (e4) => {
                var t4, r3;
                if (((d2 = false), (f2 = false), e4.done))
                  return (
                    h2 || o2.close(),
                    p2 || n2.close(),
                    null === (t4 = o2.byobRequest) ||
                      void 0 === t4 ||
                      t4.respond(0),
                    null === (r3 = n2.byobRequest) ||
                      void 0 === r3 ||
                      r3.respond(0),
                    (h2 && p2) || a2(void 0),
                    null
          ...
          b(
            ...
            (e4) => {
              ...
              if (e4.done) {
                ...
                return (
                  void 0 !== r4 &&
                    (o3 || u2.byobRequest.respondWithNewView(r4),
                    n3 ||
                      null === (t5 = c2.byobRequest) ||
                      void 0 === t5 ||
                      t5.respond(0)),
                  (o3 && n3) || a2(void 0),
                  null
...
function At(e2) {
  ...
  b(
    ...
    () => (
      (e2._pulling = false),
      e2._pullAgain && ((e2._pullAgain = false), At(e2)),
      null
    ),
    (t3) => (zt(e2, t3), null),
  );
...
function jt(e2) {
  ((e2._pullAlgorithm = void 0),
    (e2._cancelAlgorithm = void 0),
    (e2._strategySizeAlgorithm = void 0));
}
function zt(e2, t2) {
...
function Ft(e2) {
  return (
    !e2._closeRequested && "readable" === e2._controlledReadableStream._state
  );
}
function It(e2, t2, r2, o2) {
  ...
  ((a2 = void 0 !== t2.start ? () => t2.start(n2) : () => {}),
    (i2 = void 0 !== t2.pull ? () => t2.pull(n2) : () => c(void 0)),
    (l2 = void 0 !== t2.cancel ? (e3) => t2.cancel(e3) : () => c(void 0)),
    (function (e3, t3, r3, o3, n3, a3, i3) {
      ((t3._controlledReadableStream = e3),
        (t3._queue = void 0),
        (t3._queueTotalSize = void 0),
        ce(t3),
        (t3._started = false),
        (t3._closeRequested = false),
        (t3._pullAgain = false),
        (t3._pulling = false),
        (t3._strategySizeAlgorithm = i3),
        (t3._strategyHWM = a3),
        (t3._pullAlgorithm = o3),
        (t3._cancelAlgorithm = n3),
        (e3._readableStreamController = t3),
...
function Ht(e2, t2) {
  F(e2, t2);
  const r2 = null == e2 ? void 0 : e2.preventAbort,
    o2 = null == e2 ? void 0 : e2.preventCancel,
    n2 = null == e2 ? void 0 : e2.preventClose,
    a2 = null == e2 ? void 0 : e2.signal;
  return (
    void 0 !== a2 &&
      (function (e3, t3) {
        if (
...
var ReadableStream = class {
  constructor(e2 = {}, t2 = {}) {
    ...
    const r2 = Ye(t2, "Second parameter"),
      o2 = (function (e3, t3) {
        F(e3, t3);
        const r3 = e3,
          o3 = null == r3 ? void 0 : r3.autoAllocateChunkSize,
          n3 = null == r3 ? void 0 : r3.cancel,
          a2 = null == r3 ? void 0 : r3.pull,
          i2 = null == r3 ? void 0 : r3.start,
          l2 = null == r3 ? void 0 : r3.type;
        return {
          autoAllocateChunkSize:
            void 0 === o3
              ? void 0
              : N(o3, `${t3} has member 'autoAllocateChunkSize' that`),
          cancel:
            void 0 === n3
              ? void 0
              : $t(n3, r3, `${t3} has member 'cancel' that`),
          pull:
            void 0 === a2 ? void 0 : Mt(a2, r3, `${t3} has member 'pull' that`),
          start:
            void 0 === i2
              ? void 0
              : Yt(i2, r3, `${t3} has member 'start' that`),
          type: void 0 === l2 ? void 0 : Qt(l2, `${t3} has member 'type' that`),
        };
      })(e2, "First parameter");
    var n2;
    if (
      (((n2 = this)._state = "readable"),
      (n2._reader = void 0),
      (n2._storedError = void 0),
      (n2._disturbed = false),
      "bytes" === o2.type)
  ...
  pipeThrough(e2, t2 = {}) {
    ...
    $(e2, 1, "pipeThrough");
    const r2 = xt(e2, "First parameter"),
      o2 = Ht(t2, "Second parameter");
    if (this.locked)
      throw new TypeError(
...
function Zt(e2, t2) {
  ...
  const r2 = null == e2 ? void 0 : e2.highWaterMark;
  return (
    M(r2, "highWaterMark", "QueuingStrategyInit"),
    { highWaterMark: Y(r2) }
  );
}
(Object.defineProperties(ReadableStream.prototype, {
  ...
  "symbol" == typeof e.toStringTag &&
    Object.defineProperty(ReadableStream.prototype, e.toStringTag, {
      value: "ReadableStream",
      configurable: true,
    }),
  "symbol" == typeof e.asyncIterator &&
    Object.defineProperty(ReadableStream.prototype, e.asyncIterator, {
...
(Object.defineProperties(ByteLengthQueuingStrategy.prototype, {
  ...
  "symbol" == typeof e.toStringTag &&
    Object.defineProperty(ByteLengthQueuingStrategy.prototype, e.toStringTag, {
...
var TransformStream = class {
  constructor(e2 = {}, t2 = {}, r2 = {}) {
    void 0 === e2 && (e2 = null);
    const o2 = Ye(t2, "Second parameter"),
      n2 = Ye(r2, "Third parameter"),
      a2 = (function (e3, t3) {
        F(e3, t3);
        const r3 = null == e3 ? void 0 : e3.flush,
          o3 = null == e3 ? void 0 : e3.readableType,
          n3 = null == e3 ? void 0 : e3.start,
          a3 = null == e3 ? void 0 : e3.transform,
          i3 = null == e3 ? void 0 : e3.writableType;
        return {
          flush:
            void 0 === r3
              ? void 0
              : ir(r3, e3, `${t3} has member 'flush' that`),
          readableType: o3,
          start:
            void 0 === n3
              ? void 0
              : lr(n3, e3, `${t3} has member 'start' that`),
          transform:
            void 0 === a3
              ? void 0
              : sr(a3, e3, `${t3} has member 'transform' that`),
          writableType: i3,
        };
      })(e2, "First parameter");
    ...
    (!(function (e3, t3, r3, o3, n3, a3) {
        ...
        return (function (e4, t5) {
          ...
          if (e4._backpressure) {
            return p(e4._backpressureChangePromise, () => {
              if (
                "erroring" ===
                (Ge(e4._writable) ? e4._writable._state : e4._writableState)
              )
                throw Ge(e4._writable)
                  ? e4._writable._storedError
                  : e4._writableStoredError;
              return pr(r4, t5);
            });
          }
          return pr(r4, t5);
      ...
      ((e3._writableState = "writable"),
        (e3._writableStoredError = void 0),
        (e3._writableHasInFlightOperation = false),
        (e3._writableStarted = false),
        (e3._writable = (function (e4, t4, r4, o4, n4, a4, i4) {
          return new WritableStream(
            {
              start(r5) {
                ...
                try {
                  const t5 = r5.signal;
                  void 0 !== t5 &&
                    t5.addEventListener("abort", () => {
                      "writable" === e4._writableState &&
                        ((e4._writableState = "erroring"),
                        t5.reason && (e4._writableStoredError = t5.reason));
                    });
                } catch (e5) {}
                return p(
                  t4(),
                  () => ((e4._writableStarted = true), Cr(e4), null),
                  (t5) => {
              ...
              close: () => (
                ...
                p(
                  ...
                  () => (
                    (function (e5) {
                      e5._writableHasInFlightOperation = false;
                      "erroring" === e5._writableState &&
                        (e5._writableStoredError = void 0);
              ...
              abort: (t5) => (
                (e4._writableState = "errored"),
                (e4._writableStoredError = t5),
                n4(t5)
              ),
            },
            { highWaterMark: a4, size: i4 },
          );
        })(e3, i3, l3, u2, s3, r3, o3)),
        (e3._readableState = "readable"),
        (e3._readableStoredError = void 0),
        (e3._readableCloseRequested = false),
        (e3._readablePulling = false),
        (e3._readable = (function (e4, t4, r4, o4, n4, a4) {
          return new ReadableStream(
            {
              start: (r5) => (
                (e4._readableController = r5),
                t4().catch((t5) => {
                  Sr(e4, t5);
                })
              ),
              pull: () => (
                (e4._readablePulling = true),
                r4().catch((t5) => {
                  Sr(e4, t5);
                })
              ),
            ...
            { highWaterMark: n4, size: a4 },
          );
        })(e3, i3, d2, f3, n3, a3)),
        (e3._backpressure = void 0),
        (e3._backpressureChangePromise = void 0),
        (e3._backpressureChangePromise_resolve = void 0),
        fr(e3, true),
        (e3._transformStreamController = void 0));
    })(
      this,
      u((e3) => {
        b2 = e3;
      ...
      void 0 !== a2.start
        ? b2(a2.start(this._transformStreamController))
        : b2(void 0));
  }
  get readable() {
...
function dr(e2, t2) {
  (hr(e2._transformStreamController),
    (function (e3, t3) {
      e3._writableController.error(t3);
      "writable" === e3._writableState && Tr(e3, t3);
    })(e2, t2),
    e2._backpressure && fr(e2, false));
}
function fr(e2, t2) {
  (void 0 !== e2._backpressureChangePromise &&
...
(Object.defineProperties(TransformStream.prototype, {
  ...
  "symbol" == typeof e.toStringTag &&
    Object.defineProperty(TransformStream.prototype, e.toStringTag, {
...
function wr(e2) {
  ((e2._readableState = "closed"),
    (e2._readableCloseRequested = true),
    e2._readableController.close());
}
function Sr(e2, t2) {
  ("readable" === e2._readableState &&
    ((e2._readableState = "errored"), (e2._readableStoredError = t2)),
    e2._readableController.error(t2));
}
function vr(e2) {
...
function Tr(e2, t2) {
  ((e2._writableState = "erroring"),
    (e2._writableStoredError = t2),
    !(function (e3) {
...
var Blob = class _Blob {
  constructor(blobParts = [], options = {}) {
    ...
    for (const raw of blobParts) {
      ...
      __classPrivateFieldSet(
        this,
        _Blob_size,
        __classPrivateFieldGet(this, _Blob_size, "f") +
    ...
    __classPrivateFieldSet(
      this,
      _Blob_type,
      /^[\x20-\x7E]*$/.test(type) ? type : "",
      "f",
    );
  }
  static [((_Blob_parts = /* @__PURE__ */ new WeakMap()),
  (_Blob_type = /* @__PURE__ */ new WeakMap()),
  (_Blob_size = /* @__PURE__ */ new WeakMap()),
  Symbol.hasInstance)](value) {
    return Boolean(
      value &&
      typeof value === "object" &&
      isFunction(value.constructor) &&
      (isFunction(value.stream) || isFunction(value.arrayBuffer)) &&
  ...
  async text() {
    ...
    let result = "";
    for await (const chunk of consumeBlobParts(
      __classPrivateFieldGet(this, _Blob_parts, "f"),
    )) {
  ...
  stream() {
    const iterator = consumeBlobParts(
      __classPrivateFieldGet(this, _Blob_parts, "f"),
      true,
    );
    return new ReadableStream({
...
var File = class extends Blob {
  ...
  static [((_File_name = /* @__PURE__ */ new WeakMap()),
  (_File_lastModified = /* @__PURE__ */ new WeakMap()),
  Symbol.hasInstance)](value) {
    return (
