...
# Install build dependencies for native modules (libxmljs requires python3/make/g++)
RUN apt-get update && apt-get install -y --no-install-recommends python3 make g++ libxml2-dev && rm -rf /var/lib/apt/lists/*
