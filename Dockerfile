...
RUN rm -f /app/.env /app/.env.local /app/.env.development /app/.env.production /app/.env.test /app/.env.development.local /app/.env.production.local /app/.env.test.local || true
